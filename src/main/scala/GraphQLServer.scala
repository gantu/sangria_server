...
object GraphQLServer {
  val repository = ChatRepository.createDatabase()
  
  case object TooComplexQuery extends Exception
  
  val rejectComplexQueries = QueryReducer.rejectComplexQueries(300, (_: Double, _:ChatRepository) => TooComplexQuery)
